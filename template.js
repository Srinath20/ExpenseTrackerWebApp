        ...
        <tr style="width:100%">
          <td>
            <table align="center" width="100%" border="0" cellPadding="0" cellSpacing="0" role="presentation" style="margin-top:32px">
              <tbody>
                <tr>
                  <td><img alt="Slack" height="36" src="https://react-email-demo-9fn3mchcm-resend.vercel.app/static/slack-logo.png" style="display:block;outline:none;border:none;text-decoration:none" width="120" /></td>
                </tr>
              </tbody>
            </table>
                  ...
                  <td>
                    <table align="center" width="100%" border="0" cellPadding="0" cellSpacing="0" role="presentation" style="margin-bottom:32px;padding-left:8px;padding-right:8px;width:100%">
                      <tbody style="width:100%">
                        <tr style="width:100%">
                          <td data-id="__react-email-column" style="width:66%"><img alt="Slack" height="36" src="https://react-email-demo-9fn3mchcm-resend.vercel.app/static/slack-logo.png" style="display:block;outline:none;border:none;text-decoration:none" width="120" /></td>
                                ...
                                <tr>
                                  <td>
                                    <table align="center" width="100%" border="0" cellPadding="0" cellSpacing="0" role="presentation">
                                      <tbody style="width:100%">
                                        <tr style="width:100%">
                                          <td data-id="__react-email-column"><a href="/" style="color:#067df7;text-decoration:none" target="_blank"><img alt="Slack" height="32" src="https://react-email-demo-9fn3mchcm-resend.vercel.app/static/slack-twitter.png" style="display:inline;outline:none;border:none;text-decoration:none;margin-left:32px" width="32" /></a></td>
                                          <td data-id="__react-email-column"><a href="/" style="color:#067df7;text-decoration:none" target="_blank"><img alt="Slack" height="32" src="https://react-email-demo-9fn3mchcm-resend.vercel.app/static/slack-facebook.png" style="display:inline;outline:none;border:none;text-decoration:none;margin-left:32px" width="32" /></a></td>
                                          <td data-id="__react-email-column"><a href="/" style="color:#067df7;text-decoration:none" target="_blank"><img alt="Slack" height="32" src="https://react-email-demo-9fn3mchcm-resend.vercel.app/static/slack-linkedin.png" style="display:inline;outline:none;border:none;text-decoration:none;margin-left:32px" width="32" /></a></td>
                                        </tr>
                                      </tbody>
                                    </table>
                                  </td>
